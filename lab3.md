<a name="_hlk163782528"></a>**Создание системных диаграмм последовательностей**
...
|**Действие**|<p>**Запросить имя, вывести текстовое поле**</p><p>**и неактивную кнопку «Сохранить»**</p>|
| :-: | :-: |
...
|**Действие**|<p>**Показать поле, набор кораблей**</p><p>**и неактивную кнопку «Сохранить»**</p>|
| :-: | :-: |
...
|**Действие**|<p>**В поле игрока отобразить метки,**</p><p>**появившиеся при предыдущем ходе**</p>|
| :-: | :-: |
|Ссылки|Прецедент: Сделать ход|
...
|**Действие**|<p>**Предоставить право хода игроку,**</p><p>**отобразить его поле и поле соперника**</p>|
| :-: | :-: |
|Ссылки|Прецедент: Сделать ход|
|Предусловия|<p>(Если ход не первый в игре и не повторный) Поле игрока содержит все метки с предыдущего хода</p><p>(Если ход первый в игре)</p><p>1. Оба игрока вошли в игру</p><p>2. Оба игрока сформировали свои игровые поля, расставив корабли</p><p>3. Выбран игрок, который будет ходить первым</p><p>4. Игра начата</p>|
