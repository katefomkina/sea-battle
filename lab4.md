...
| ------------ | ---------------------------------------------------- |
| Ссылки       | Прецедент "Сделать ход"                              |
| Предусловия  | <p>1.	Текущий ход не первый в игре (атрибут mode.id != 0) и не повторный (атрибут mode.isRepeat == False)</p><p>2.	У обоих игроков есть непотопленные корабли</p> |
